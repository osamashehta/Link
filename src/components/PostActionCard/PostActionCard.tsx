...
const PostActionCard = ({postId, token, setShowEditPost, showEditPost}: {postId: string, token: string, setShowEditPost: (showEditPost: boolean) => void, showEditPost: boolean}    ) => {
